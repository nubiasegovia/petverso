                                ...
                                <div className="row border-bottom mx-0 pt-4 px-2 align-items-center">
                                    <div className="col-xl-3 col-xxl-4 col-lg-6 col-sm-12 mb-sm-4 mb-3 align-items-center  media">
                                        ...
                                        <div className="media-body">
                                            ...
                                            <span className="d-block mb-lg-0 mb-0">Comidas Saudáveis e Saborosas Para Cães Feitas Sem Adições de Conservantes ou Corantes. Trabalhamos Apenas Com Ingredientes Saudáveis e de Alto Valor Nutricional. Confira! Comidas Super Saborosas. Seu Pet Mais Saudável. </span>
                                        </div>
                                    </div>
